    ...
    <div class="landing-page">
        <div class="on-mobile">
            ...
            <div class="mobile-table">
                ...
                <img class="no-mobile" src="./../../public/icons/sad_palmart.png">
            </div>
        </div>
        <div class="header-landing">
            <img class="palmart-logo" src="./../../public/icons/logo.png">
            ...
            <div class="info-pages">
                ...
                >
                    <div class="intro-top">
                        ...
                        <h3><i>everything is available</i></h3>
                        <br>
                        <p>palmart is the best place on the internet to get amazing sellers and buyers!</p>
                        <p>Browse through local items and connect with best sellers post somthig amaizing and get best buyers.</p>
                        <p>If you like what you see and want to buy it give it like and you can connect!</p>
                    </div>
                </div>
                <div
                        v-if="!intro && features && !about"
                    ...
                    <div class="row1">
                        ...
                        <div class="column1">
                            <h3>Sign up</h3>
                            <p>Make a profile that shows your items!<p>
                    ...
                    <div class="row2">
                        <div class="column2">
                            <h3>Browse</h3>
                            <p>Use a familiar and intuitive interface to see items in your area</p>
                    ...
                    <div class="row3">
                        ...
                        <div class="column3">
                            ...
                            <p>Display the contact email for matched items and make plans to connect.</p>
                        </div>
                    </div>
                </div>
                <div
                        ...
                        class="about">
                    <h3>Why palmart?</h3>
                    <p>This is our Portfolio Project, concluding our Foundations Year at <a href="https://www.alxafrica.com/">ALX Africa</a>.
                    ...
                    <p>The idea of palmart came from the team's passion for marketing platform and online shoping.
                        We know that sellers need buyers need to find convenient place to connect like a market place in their hand </p>
                        that is why we call it palmart.</p>
                 <br>
                    <h4>The Team</h4>
                    <p>Samson mekonnen - <a href="https://www.linkedin.com/in/samson-mekonnen-unique/">LinkedIn</a>
                        &nbsp;<a href="https://github.com/samiunique">GitHub</a>
                        &nbsp;<a href="https://twitter.com/sam4unique">Twitter</a></p>
                    <br>
                    <h4>Check out the source code for palmart!</h4>
                    <a href="https://github.com/samiunique/palmart">palmart on GitHub</a>
                </div>
            </div>
        </div>
